  ...
  describe("getNonTerminatedContracts", () => {
    ...
    describe("when there are all terminated", () => {
      beforeAll(async () => {
        ...
        terminatedContractAttr = generateContract({
          ClientId: client.id,
      ...
      it("should get no one", async () => {
        const contracts = await Contract.getNonTerminatedContracts();
    ...
    describe("when there is one new", () => {
      ...
      beforeAll(async () => {
        ...
        terminatedContract = await Contract.create(terminatedContractAttr);
        newContractAttr = generateContract({
          ClientId: client.id,
          ContractorId: contractor.id,
    ...
    describe("when there is one inprogress", () => {
      ...
      beforeAll(async () => {
        ...
        terminatedContract = await Contract.create(terminatedContractAttr);
        inprogressContractAttr = generateContract({
          ClientId: client.id,
          ContractorId: contractor.id,
